...
esegui_tutti_test ()
{
    # se il programma legge una intera riga, incluso una riga vuota,
    # oltre ad altri elementi (caratteri, numeri, parole) per qualche
    # funzionalita', allora, per passare anche tale riga in input al
    # programma, bisogna inserire un \n alla fine della riga, nella
    # stringa completa dell'input

    esegui_test "stampa senza vendita" "" "2 7" 0


    esegui_test "vendita senza stampa" "" "1 Mario 3213 7" 0


    esegui_test "vendita di un biglietto con stampa" "" "1 Mario 1241 2 7" 1 "Mario 1241"

    esegui_test "vendita di due biglietti con stampa" "" "1 Mario 1241 1 Anna 431243 2 7" 2 "Mario 1241" "Anna 431243"

    esegui_test "vendita di tre biglietti con doppia stampa" "" "1 Mario 1241 1 Anna 431243 2 1 Federico 1412 2 7" 3 "Mario 1241" "Anna 431243" "Federico 1412"

    esegui_test "vendita di due biglietti con stesso numero" "" "1 Mario 1241 1 Anna 1241 2 7" 1 "Mario 1241"

    esegui_test "vendita di due biglietti con stesso nome" "" "1 Mario 1241 1 Mario 1242 2 7" 2 "Mario 1241" "Mario 1242"

    esegui_test "vendita biglietto con numero 0" "" "1 Mario 0 2 7" 0

    # doppia reinizializzazione con seconda a vuoto
    # doppia reinizializzazione con seconda a un elemento
    # doppia reinizializzazione con seconda a molti elementi
    ...
    esegui_test "salvataggio" 3 "1 Mario 1241 1 Anna 431243 3 2 7" 2 "Mario 1241" "Anna 431243"

    esegui_test "salvataggio e vendita successiva" 3 "1 Mario 1241 1 Anna 431243 3 2 1 Federico 1412 2 7" 3 "Mario 1241" "Anna 431243" "Federico 1412"


    # salvataggio e reinizializzazione

    esegui_test "caricamento" 4 "4 2 7" 2 "Mario 1241" "Anna 431243"

    # caricamento dopo reinizializzazione

    esegui_test "inserimento dopo caricamento" 4 "4 1 Mario 32132 2 7" 3 "Mario 1241" "Anna 431243" "Mario 32132"

    esegui_test "caricamento dopo inserimento di piÃ¹ elementi" 4 "1 Michele 1724 1 Rita 38243 1 Federico 3123 2 4 2 7" 2 "Mario 1241" "Anna 431243"

    esegui_test "salvataggio e caricamento dopo inserimento di meno elementi" 4 "1 Michele 1724 1 Rita 38243 1 Federico 3123 3 1 Mario 32132 4 2 7" 3 "Michele 1724" "Rita 38243" "Federico 3123"

    esegui_test "solo caricamento dopo inserimento di meno elementi" 4 "1 Mario 32132 4 2 7" 3 "Michele 1724" "Rita 38243" "Federico 3123"

    esegui_test "estrai biglietto da insieme vuoto" 5 "5 7" 1 "NESSUNO 0"

    esegui_test "estrai biglietto da insieme con un elemento" 5 "1 Mario 10 5 7" 1 "Mario 10"

    esegui_test "estrai tre biglietti da insieme vuoto" 6 "6 3 7" 1 "NESSUNO 0"

    esegui_test "estrai tre biglietti da insieme con un elemento" 6 "1 Mario 10 6 3 7" 1 "Mario 10"
    ...
    esegui_test "reinizializzazione ad un carattere dopo caricamento" 4 "4 2 1 1 1 P 2 7" 1 "P"

    esegui_test "stampa carattere su codice vuoto" 5 "5 1 1 7" 1 "FALLITO"

    esegui_test "stampa carattere su codice non vuoto" 5 "4 5 1 1 7" 1 "T"

    esegui_test "tentativo di stampa carattere con posizione nella riga troppo grande" 5 "4 5 4 1 7" 1 "FALLITO"

    esegui_test "ruota codice vuoto" 6 "6 2 7" 0

    esegui_test "ruota codice un carattere" 6 "1 1 1 P 6 2 7" 1 "P"

    esegui_test "ruota codice una riga" 6 "1 1 2 P Q 6 2 7" 1 "P | Q"

    esegui_test "ruota codice due righe da un carattere" 6 "1 2 1 P Q 6 2 7" 1 "P Q"

    esegui_test "ruota codice molte righe" 6 "4 6 2 7" 1 "P U H W | H T C E | A G Z P"
    ...
    #Â esegui_test "scambia parola non vuota con minima non vuota" 6 "4 2 6 0 0 2 7" 3 "Quo Paperino" "Minnie" "Pippo"
