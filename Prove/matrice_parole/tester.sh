...
esegui_tutti_test ()
{
    ...
    esegui_test "stampa senza reinizializzazioni" "" "2 7" 3 "" "" ""

    esegui_test "sostituzione di una parola senza stampa" "" "1 pippo 0 0 7" 0

    esegui_test "sostituzione di una parola con stampa" "" "1 pippo 0 0 2 7" 3 "pippo" "" ""


    # esegui_test "reinizializzazione a lunghezza massima uno" "" "1 1 2 7" 0

    # esegui_test "reinizializzazione a lunghezza massima due" "" "1 2 2 7" 0

    # esegui_test "reinizializzazione a una operazione" "" "1 1 A 1\n 2 7" 1 "A 1"
    esegui_test "sostituzione di due parole nella stessa riga" "" "1 pippo 0 0 1 pluto 0 1 2 7" 3 "pippo pluto" "" ""

    esegui_test "sostituzione di due parole in righe diverse" "" "1 pippo 0 0 1 pluto 1 1 2 7" 3 "pippo" "pluto" ""

    esegui_test "doppia sostituzione di una parola corta-lunga" "" "1 p 0 0 1 pluto 1 1 1 minnie 0 0 2 7" 3 "minnie" "pluto" ""

    esegui_test "doppia sostituzione di una parola lunga-corta" "" "1 pippo 0 0 1 pluto 1 1 1 m 0 0 2 7" 3 "m" "pluto" ""

        esegui_test "tentativo sostituzione fuori matrice" "" "1 pippo 0 10 2 7" 3 "" "" ""
    ...
    esegui_test "salvataggio" 3 "1 Pippo 0 0 1 Paperino 0 1 1 Minnie 1 0 1 Quo 2 1 3 2 7" 3 "Pippo Paperino" "Minnie" "Quo"

    esegui_test "caricamento" 4 "4 2 7" 3 "Pippo Paperino" "Minnie" "Quo"

    esegui_test "caricamento dopo sostituzioni" 4 "1 pippo 0 0 1 pluto 1 1 2 4 2 7" 3 "Pippo Paperino" "Minnie" "Quo"

    esegui_test "sostituzioni dopo caricamento" 4 "4 2 1 Qui 0 0 1 pluto 1 1 2 2 7" 3 "Qui Paperino" "Minnie Pluto" "Quo"
    ...
    esegui_test "scambia su matrice vuota" 5 "5 0 0 2 1 2 7" 3 "" "" ""

    esegui_test "scambia tra due parole non vuote" 5 "4 5 0 0 2 1 2 7" 3 "Quo Paperino" "Minnie" "Pippo"

    esegui_test "scambia con una parola vuota" 5 "4 5 0 0 2 0 2 7" 3 "Paperino" "Minnie" "Pippo Quo"
...
g++ -std=c++11 -Wall -Werror -pedantic-errors $sorgente
