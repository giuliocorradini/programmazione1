...
esegui_tutti_test ()
{
    ...
    esegui_test "reinizializzazione senza stampa" "" "1 1 A 7" 0

    esegui_test "reinizializzazione" "" "1 1 A 2 7" 1 "A"

    esegui_test "reinizializzazione con carattere non valido" "" "1 1 j 2 7" 1 "A"

    esegui_test "reinizializzazione a 4 elementi" "" "1 2 A B C D 2 7" 2 "A B" "C D"

    esegui_test "reinizializzazione a 4 elementi con carattere non valido" "" "1 2 A B z D 2 7" 2 "A B" "A D"


#    "vendita di un biglietto con stampa"

    # doppia reinizializzazione con seconda a vuoto
    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 2 A B z D 2 1 0 7" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda ad un elemento" "" "1 2 A B z D 2 1 1 A 2 7" 1 A

    # doppia reinizializzazione con seconda a 4 elementi
    esegui_test "doppia reinizializzazione con seconda a 4 elementi" "" "1 1 C 1 2 A B z D 2 7" 2 "A B" "A D"

    # doppia reinizializzazione con prima a vuoto e seconda a 4 elementi
    esegui_test "doppia reinizializzazione con prima a vuoto e seconda a 4 elementi" "" "1 0 2 1 2 A B z D 2 7" 2 "A B" "A D"

    # doppia reinizializzazione con prima a vuoto e seconda a 16 elementi
    esegui_test "doppia reinizializzazione con prima a vuoto e seconda a 16 elementi" "" "1 0 2 1 4 A G O E M O I W I L M L C A S A 2 7" 4 "A G O E" "M O I W" "I L M L" "C A S A"
    ...
    # "salvataggio"
    esegui_test "salvataggio" 3 "1 0 2 1 4 A G O E M O I W I L M L C A S A 3 2 7" 4 "A G O E" "M O I W" "I L M L" "C A S A"

    # salvataggio e reinizializzazione
    esegui_test "salvataggio" 3 "1 0 2 1 4 A G O E M O I W I L M L C A S A 3 1 1 A 2 7" 1 "A"

    # "caricamento"
    esegui_test "caricamento" 4 "4 2 7" 4 "A G O E" "M O I W" "I L M L" "C A S A"

    # reinizializzazione a meno elementi dopo caricamento
    esegui_test "reinizializzazione a meno elementi dopo caricamento" 4 "4 1 1 C 1 2 A B z D 2 7" 2 "A B" "A D"

    # caricamento dopo reinizializzazione
    esegui_test "caricamento dopo reinizializzazione" 4 "1 1 C 1 2 A B z D 4 2 7" 4 "A G O E" "M O I W" "I L M L" "C A S A"

    # "inserimento dopo caricamento"

    # "caricamento dopo inserimento di piÃ¹ elementi"
    ...
    esegui_test "ricerca di una parola presente in su" 5 "4 5 MIO 7" 1 "PRESENTE"

    esegui_test "ricerca di una sotto parola presente in su" 5 "4 5 IO 7" 1 "PRESENTE"

    esegui_test "ricerca di una parola lunga presente in giu" 5 "4 5 GOLA 7" 1 "PRESENTE"

    esegui_test "ricerca di una parola lunga presente in su" 5 "4 5 CIMA 7" 1 "PRESENTE"

    esegui_test "ricerca di una parola lunga presente in orizzontale" 5 "4 5 CASA 7" 1 "ASSENTE"

    esegui_test "ricerca di una parola corta presente in orizzontale" 5 "4 5 AGO 7" 1 "ASSENTE"

    esegui_test "ricerca di una parola assente" 5 "4 5 AGO 7" 1 "ASSENTE"

    esegui_test "ricerca globale di una parola molto corta presente" 6 "4 6 IO 7" 1 "PRESENTE"

    esegui_test "ricerca globale di una parola corta presente" 6 "4 6 AGO 7" 1 "PRESENTE"

    esegui_test "ricerca globale di una parola lunga presente" 6 "4 6 CASA 7" 1 "PRESENTE"

    esegui_test "ricerca globale di una parola molto lunga presente" 6 "4 6 CASALE 7" 1 "PRESENTE"

    esegui_test "ricerca globale di una parola assente" 6 "4 6 PINO 7" 1 "ASSENTE"

    esegui_test "ricerca globale di una parola assente ma contenente una parola presente" 6 "4 6 CASATO 7" 1 "ASSENTE"
